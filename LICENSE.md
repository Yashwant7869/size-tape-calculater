...
Access to the source code does not grant any right or license to use the Software.
...
* Using the Software as part of a SaaS, cloud, or hosted service.
* Selling products or services based on the Software.
* Integrating the Software into another commercial application.
* Providing the Software or its functionality to customers or third parties.
* Using the Software for business operations that generate revenue.
* Using the Software directly or indirectly to generate income.
* Offering the Software, modified versions, or derivative works as a paid product or service.

No commercial use is permitted without prior written authorization.
...
No commercial rights are granted until the applicable written agreement has been executed and any required fees have been paid.
...
* Application stores.
* Public APIs exposing the Software.
* SaaS platforms using the Software.
* Any other public or private distribution channel.
...
All copyright notices, proprietary notices, trademarks, license notices, and other ownership notices contained in the Software must remain intact.

No person or entity may remove, alter, conceal, or replace copyright or ownership notices without prior written permission.
...
The availability of the Software, including availability through a source-code repository, does not by itself grant any license or permission to use the Software.

---

## 11. Third-Party Components

The Software may contain or depend upon third-party libraries, frameworks, packages, tools, or other components that are subject to their own licenses.
...
Any unauthorized use, copying, modification, distribution, publication, sublicensing, or commercialization of the Software constitutes a violation of this License.

Any permission or license granted under a separate written agreement may be terminated according to the terms of that agreement.

Upon termination or expiration of an applicable license, the licensee must immediately cease all use of the Software to the extent required by the applicable agreement and must delete or return copies of the Software where required.
...
* Expected number of users or installations.
* Distribution method.
* Expected revenue, where applicable.
...
This License shall be governed by and interpreted in accordance with the applicable laws of **India**, unless otherwise agreed in a separate written agreement.

Any dispute arising out of or relating to this License shall be subject to the jurisdiction of the courts having appropriate jurisdiction as agreed or determined under applicable law.
